...
const VideoControls = React.memo(
  ({
    ...
    if (hasError)
      return <div className="project-thumb-error">Preview unavailable</div>;
    ...
    return (
      <>
        ...
        />
        {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- stops click bubbling only; the interactive children are real <button>s */}
        <div
          className="project-thumb-controls"
